...
$insert=mysqli_query($con,"INSERT INTO consultas VALUES ('','35','$a1','$a2','$a3','$a4','$a5','$a6')");          
             ...
             <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                       <div class="x_panel" style="background:#81F79F;">
                        <form  name="myForm" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="consulta5.php">

...
<head>
  ...
  <title>Variables Laborales</title>
...
<body class="nav-md">
              ...
              <div class="panel panel-info">
                <div class="panel-heading">
                  <div class="btn-group pull-right">
                    <button type='button' class="btn btn-header" data-toggle="modal" data-target="#nuevoProducto"><span class="glyphicon glyphicon-plus"></span> Nueva Variable</button>
                  </div>
                  <h4>Buscar variables descansos</h4>
                </div>
                <div class="panel-body">
                  ...
                  <form class="form-horizontal" role="form" id="datos_cotizacion">
                    ...
                    <div class="form-group row">
                      <label for="q" class="col-md-2 control-label">Buscar variables</label>
                      <div class="col-md-5">
                        <input type="text" class="form-control estilo-placeholder" id="q" placeholder="Buscar variables" onkeyup='load(1);'>
                      </div>
                      <div class="col-md-3">
  ...
  <script>
    ...
    function load(page) {
      ...
      $("#loader").fadeIn('slow');
      $.ajax({
        url: './ajax/buscar_variables.php?action=ajax&page=' + page + '&q=' + q,

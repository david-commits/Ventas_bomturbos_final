        ...
        $date_added=date("Y-m-d H:i:s");
           ...
           if ($query_check_user == 1) {
               ...
               // write new user's data into database
                    $sql = "INSERT INTO users (nombres, clave, user_name,hora, user_email, date_added,accesos,dni,domicilio,telefono,sucursal,foto,estado)
                            VALUES('".$firstname."','".$user_password."','" . $user_name . "', NOW(), '" . $user_email . "', '" .$date_added."','".$c."','".$dni."','".$domicilio."','".$telefono."','".$tienda1."','user.png','".$estado."');";

...
$hora_salida=$row1["hora_salida"];
    ...
    $resultado=calcular_tiempo_trasnc($hora_entrada,$hora); 
                $sql="";
		if($tipo_reg==1){
		$sql="INSERT INTO asistencia (unico,user_id, hora_entrada,fecha_entrada,hora_base,hora_salida,fecha_salida,min_tardanza,asistencia) VALUES ('$valor','$nombre1','$hora_entrada','$fecha_entrada','$hora','','$fecha_entrada','$resultado','0')";
		}

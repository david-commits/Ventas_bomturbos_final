			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
                   ...
                   ?>                    
                                                ...
                                                <td class="text-right">
					<!--	<a href="editar_factura.php?id_factura=" class='btn btn-default' title='Editar factura' ><i class="glyphicon glyphicon-edit"></i></a> -->
                                                ...
                                                <a href="#" title='Editar servicio' onclick="obtener_datos('<?php echo $id_servicio;?>');" data-toggle="modal" data-target="#myModal2" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>  </a>
                                                         ...
                                                         <!--	<a href="#" class='btn btn-default' title='Borrar servicio' onclick="eliminar('<?php ///echo $id_servicio; ?>')"><i class="glyphicon glyphicon-trash"></i> </a-->

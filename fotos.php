...
<div class="panel panel-info">
  <br><br><br>
    <div class="panel-heading">
        Editar datos del producto para web:
    </div>        
</div>  
...
?>
				...
				<div class="col-sm-8">
                                    ...
                                    <input type="text"  class="form-control estilo-placeholder" id="codigo" name="codigo" value="<?php echo $codigo;?>" readonly="">
				</div>
			  </div>
				...
				<div class="col-sm-8">
					<input  type="text" class="form-control estilo-placeholder"  name="nombre" value="<?php echo $producto;?>" readonly="">
				...
				<div class="col-sm-8">
					<input  type="text" class="form-control estilo-placeholder"  name="pre_web" required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$" value="<?php echo $pre_web;?>" requrired>
				...
				<div class="col-sm-8">
					<textarea class="form-control estilo-placeholder" rows="2" name="descripcion" requrired><?php echo $descripcion;?></textarea>

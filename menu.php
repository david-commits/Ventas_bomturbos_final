...
// $db = mysqli_connect('127.0.0.1', 'root', 'Pa$$word123@');
    if (!$db) {
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-barcode"></i> Mantenimiento <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="categorias.php">Categorias</a>
                    </li>
                    <li><a href="marca.php">Marca</a>
                    <li><a href="motor.php">Motor</a>
                    <li><a href="modelo.php">Modelo</a>
                    <li><a href="vehiculos.php">Parque Automotor</a>
                    <li><a href="tipoLinea.php">Tipo Linea</a>
                    <li><a href="tipoArticulo.php">Tipo Articulo</a>
                    <li><a href="constante.php">Constante</a>
                  </ul>
                </li>
                ...
                <li><a><i class="fa fa-barcode"></i> Productos <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <!--<li><a href="compatible.php">Lista de Productos compatibles</a>
                    </li>-->
                ...
                <li><a><i class="fa fa-user"></i> Clientes <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="ingresocliente.php"><img src="ajax/sunat.png" width="25" height="25">Consultar Ruc Sunat</a>
                    </li>
                  </ul>
                </li>
                ...
                <li><a><i class="fa fa-list-alt"></i> Ventas Productos<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="nueva_factura.php">Ventas Fact/Bol/Guia</a></li>
                    <li><a href="facturas.php">Lista de  Ventas</a></li>
                    <li><a href="facturaseliminadas.php" style="color: #ca5464 !important; font-weight: 600;">Ventas Eliminadas</a></li>
                    <li><a href="facturaelectronica.php"><img src="ajax/sunat.png" width="20" height="20" style="margin-right: 5px;"><b>Facturación Electrónica</b></a></li>
                ...
                <li><a><i class="fa fa-shopping-cart"></i> Despachos <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">                    
                    <li><a href="despachos.php">Despacho</a></li>
                  </ul>
                </li>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="images/tienda.jpg" alt=""><?php echo $_SESSION['nombre_sucur']; ?>
...
while ($valor1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
    ...
    $nombresucursal=$valor1['nombre'];   

if ($_SESSION['tienda'] == $tienda) {?>
  <li checked><a href="tienda.php?t=<?php echo $tienda;?>&a=<?php echo $a;?>"><?php echo $nombresucursal;?>  </a> </li>
<?php }else{ ?>
  <li><a href="tienda.php?t=<?php echo $tienda;?>&a=<?php echo $a;?>"><?php echo $nombresucursal;?>  </a> </li>
<?php }
...
<?php }
              ...
              ?> 
                ...
                <li role="presentation" class="dropdown">
                    <a href="http://precisamotor.com/" target="_blanck" title="Pagina Web y Carrito de Compras">
...
<footer>
    ...
    <div class="copyright-info">
              ...
              <p class="pull-right">Desarrollado por 
                   <a href="https://www.agilesolutions.pe" target="_blank" class="text-light">Agile Solutions</a> &copy <?php echo date('Y');?>
              </p>
          </div>

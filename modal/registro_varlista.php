    ...
    $tienda1=$_SESSION['tienda'];
        ...
        <div class="modal fade" id="nuevoProducto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Agregar nueva variable a empleado</h4>
          </div>
            ...
            <div id="resultados_ajax"></div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <input type="date" class="form-control estilo-placeholder" name="fecha_entrada" id="fecha_entrada" >
                </div>
            </div>
                    <div class="form-group">
                <label for="nombre" class="col-sm-3 control-label">Tipo de Variable</label>
                <div class="col-sm-8">
                 <select class="form-control estilo-placeholder" id="variable" name="variable" required >
                    <option class="custom-select" value="">-- Selecciona Variable --</option>
                                        <?php
                                        ...
                                        while($row3=mysqli_fetch_array($rs1)){
                                            ...
                                            if($id_laboral>0){
                                                ...
                                                <option class="custom-select" style="color:<?php  echo $col_var;?>" value="<?php  echo $id_laboral;?>"><?php  echo $cod_var ;?> </option>

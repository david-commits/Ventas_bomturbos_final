		...
		<div class="modal-content" style="background: #F5ECCE;">
		  ...
		  <div class="modal-header" style="background: #58FAAC;">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i><font color="black"> Agregar nueva operación en la Sucursal<?php echo $_SESSION['tienda']; ?></font></h4>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="guardar_otrospagos" name="guardar_otrospagos">
			<div id="resultados_ajax_productos"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
					<input type="text" class="form-control" id="nombre" name="nombre" placeholder="Breve descripción de la operación" required>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				 <select class="form-control" id="vendedor" name="vendedor" required>
					<option value="">-- Selecciona Vendedor --</option>
                        ...
                        $rs1=mysqli_query($con,$sql2);
                        while($row3=mysqli_fetch_array($rs1)){
                            $nom_cat=$row3["nombres"];
                            $id_categoria=$row3["user_id"];
                        ?>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input type="text" class="form-control" id="pago" name="pago" placeholder="Cantidad a pagar o cobrar en S/" required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="8">
				</div>
			  </div>
			 ...
			 <div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
                                    <textarea class="form-control" id="obs" name="obs"  placeholder="Detalle"></textarea>

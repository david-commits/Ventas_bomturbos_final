	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content" style="background: #F5ECCE;">
		  ...
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="editar_otrospagos" name="editar_otrospagos">
			<div id="resultados_ajax2"></div>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				 <select class="form-control" id="mod_vendedor" name="mod_vendedor" required>
			  ...
			  <div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input type="text" class="form-control" id="mod_pago" name="mod_pago" placeholder="Cantidad a pagar o cobrar en S/" required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="8">
				</div>
			  </div>

...
<head>
  ...
  <title>Editar Foto Usuario</title>
  ...
  <div class="container body">
    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        ...
        <div class="contorno-para-divs">
          <div class="panel panel-info">
            <div class="panel-heading"><h4>Editar foto de la sucursal:</h4></div>
          </div>
          <?php
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <input type="text" class="form-control estilo-placeholder" id="nombre" name="nombre" value="<?php echo $nombre; ?>" readonly="">
            </div>
          </div>
          <div class="form-group">
            <label for="nombre" class="col-sm-3 control-label">Editar foto:</label>
            <div class="col-sm-5">
              <input accept="image/jpeg" type="file" id="files" name="files" class="form-control estilo-placeholder" />

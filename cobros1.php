...
//$sql="select * from products ORDER BY  `products`.`id_producto` DESC LIMIT 0 , 100";
 ...
 <?php   
    ...
    $sql="select * from facturas,clientes, users where facturas.id_cliente=clientes.id_cliente and facturas.id_vendedor=users.user_id and facturas.ven_com=3 and facturas.activo=1 and facturas.id_cliente=$a"; 
...
$total_venta=$row['total_venta'];
        ...
        <tr id="valor1">
                        ...
                        <td class=" "><a href="eliminarcobros.php?id=<?php echo $id;?>">Eliminar </a></td>

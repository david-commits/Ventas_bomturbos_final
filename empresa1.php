...
,dir_emp='".$dir_emp."',tel_emp='".$tel_emp."',email_emp='".$email_emp."',face_emp='".$face_emp."',tiwter_emp='".$tiwter_emp."',youtube_emp='".$youtube_emp."',comentario1='".$comentario1."',comentario2='".$comentario2."',comentario3='".$comentario3."',comentario4='".$comentario4."',comentario5='".$comentario5."'
where id_emp=1";

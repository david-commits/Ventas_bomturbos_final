...
$insert=mysqli_query($con,"INSERT INTO consultas VALUES ('','31','$a1','$a2','$a3','$a4','$a5','$a6')");           
           ...
           <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                       <div class="x_panel" style="background:#81F79F;">
                        <form  name="myForm" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="consulta1.php">
                         ...
                         <div class="col-md-4 col-sm-4 col-xs-12">
                           ...
                           <?php
                            ...
                            if($tipo==1){
                                ...
                                ?>
                                <option class="custom-select"  selected value="1" >Mensual</option>
                             <?php
                                }else{
                                   ?>
                                <option class="custom-select"  value="1" >Mensual</option>
                             <?php  

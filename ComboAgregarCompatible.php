...
$cadena="<select required id='modelo' v-model=\"filtroProducto.modelo\" name='modelo' style=\"background-color:#A9F5BC;\" class='form-control'>";
//var_dump(mysqli_fetch_row($result));die;
while ($ver=mysqli_fetch_row($result)) {
    $cadena=$cadena.'<option class="custom-select" class="custom-select"  value='.$ver[0].'>'.utf8_encode($ver[1]).'</option>';
}
echo  $cadena."</select>";

    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
		  ...
		  <div class="modal-body" style="background: #E1F5A9;">
                      <form class="form-horizontal" method="post" action="pago2.php" id="nuevo_pagos" name="nuevo_pagos">
			<div id="resultados_ajax2"></div>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input type="text" class="form-control" value="<?php echo $deuda1;?>" id="mod_deuda" name="mod_deuda" readonly>
				   ...
				   <font color="red"><input tyoe="text" value="Deuda	S/." readonly></font> 
                        ...
                        <?php
                        $total1=0;
                        $sql2="select * from facturas where id_cliente=$id and activo=1 and ven_com=2";
                        $i=0;
                        ...
                        while($row3=mysqli_fetch_array($rs1)){
                            ...
                            if($t>0){
                                ...
                                ?>
                                <div class="form-group">
                                <label for="mod_deuda" class="col-sm-3 control-label"><?php echo $doc;?> <?php echo $numero;?></label>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                    <input type="number"  class="monto"  onkeyup="sumar();" value="<?php echo $t;?>" id="deuda<?php echo $i;?>" name="deuda<?php echo $i;?>" readonly>
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" class="monto"   onkeyup="sumar();" value="<?php echo $deuda1-$suma;?>" id="deuda<?php echo $i+1;?>" name="deuda<?php echo $i+1;?>" readonly>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
                                    <input type="number"  style="background-color: #F5D0A9;" required autocomplete="off" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '<?php echo $deuda1;?>';}" step="0.1" min="0" max="<?php echo $deuda1;?>" value="<?php echo $deuda1;?>" id="spTotal" name="spTotal" >
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input type="text" style="background-color: #F5D0A9;" autocomplete="off" class="form-control" id="numero_factura" name="numero_factura" placeholder="Nro del documento" required>
				</div>
			  </div>

...
if($aceptar==1){
    ...
    $sql="INSERT INTO clientes values ('','','$nombre','$telefono','$email','$direccion','$estado','$date_added','$doc','$dni','$ven','Peru','$departamento','$provincia','$distrito','$cuenta','1','$tienda1','0','0','0')";
...
if($ruc1==1){
    ...
    $consulta = "INSERT INTO consultas values ('','30','$a1','$a2','$a3','$a4','$a5','$a6')";
